...
class TeacherAnnouncements extends StatefulWidget {
  const TeacherAnnouncements({Key? key}) : super(key: key);
...
class _TeacherAnnouncementsState extends State<TeacherAnnouncements> {
  ...
  Future<void> initData() async {
    ...
    try {
      ...
      log(
        '------------------------------->>>>>>>>>>>>>> Error in teacher announcements: $e',
      );
    } finally {
  ...
  Future<void> loadAnnouncements() async {
    try {
      final result = await controller.getAnnouncementsList(
        subjectId: subjectId,
        classId: classId,
        sectionId: sectionId,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  'Class $className • Section $sectionName • $subjectName',
                  style: TextStyle(
    ...
    return Container(
      ...
      child: InkWell(
        ...
        onTap: () {
          ...
          commonSnackBar(
            message: "Announcement details coming soon!",
            color: AppColors.blueColor,
          );
        },
        child: Padding(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  // Whatsapp indicators
                  if (announcement.sendToStudentWhatsapp ||
                      announcement.sendToParentWhatsapp)
                    Row(
                      children: [
                        Icon(
                        ...
                        SizedBox(width: getWidth(4)),
                        Text(
                          announcement.sendToStudentWhatsapp &&
                                  announcement.sendToParentWhatsapp
                              ? "Sent to all"
                              : announcement.sendToStudentWhatsapp
                              ? "Sent to students"
