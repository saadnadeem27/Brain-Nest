...
class TeacherClassroomResources extends StatefulWidget {
  const TeacherClassroomResources({Key? key}) : super(key: key);

  @override
  State<TeacherClassroomResources> createState() =>
      _TeacherClassroomResourcesState();
}

class _TeacherClassroomResourcesState extends State<TeacherClassroomResources> {
  ...
  Future<void> initData() async {
    ...
    try {
      ...
      // Load chapters for all classes
      await loadChapters();
    } catch (e) {
      log('Error in initData of TeacherClassroomResources: $e');
    } finally {
  ...
  Future<void> loadChapters() async {
    ...
    try {
      final List<ChapterModel>? chaptersList =
          await controller.getMyClassroomResourceChapterList();
      ...
      log('Error loading classroom chapters: $e');
    } finally {
      isLoading.value = false;
    }
  }
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      // For class teacher resources, we don't pass subject, class or section IDs
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "Add your first chapter to organize classroom resources",
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: getWidth(16),
              color: AppColors.textColor.withOpacity(0.7),
  ...
  Widget _buildChaptersList() {
    return ListView(
      ...
      children: [
        // Teacher classroom resources info card
        Container(
